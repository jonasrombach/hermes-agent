...
WHISPER_HALLUCINATIONS = {
    ...
    "ard text im auftrag des zdf",
    "ard text im auftrag des wdr",
    "ard text im auftrag des br",
    "ard text im auftrag des ndr",
...
_HALLUCINATION_REPEAT_RE = re.compile(
    r'^(?:thank you|thanks|bye|you|ok|okay|the end|vielen dank|dankeschön|danke schön|danke|tschüss|\.|\s|,|!)+$',
    flags=re.IGNORECASE,
)
