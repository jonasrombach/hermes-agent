...
WHISPER_HALLUCINATIONS = {
 ...
 "vielen dank", "vielen dank.", "danke", "danke.", "dankeschön", "dankeschön.",
 "danke schön", "danke schön.", "vielen dank fürs zuschauen", "vielen dank fürs zuschauen.",
 "vielen dank für eure aufmerksamkeit", "vielen dank für ihre aufmerksamkeit", "tschüss", "tschüss.",
 "bis zum nächsten mal", "bis zum nächsten mal.", "untertitel", "untertitel:", "untertitelung",
 "untertitelung:", "ard text", "ard text im auftrag von funk", "ard text im auftrag des zdf",
 "ard text im auftrag des wdr", "ard text im auftrag des br", "ard text im auftrag des ndr",
 "untertitel im auftrag des zdf", "untertitelung im auftrag des zdf", "copyright wdr", "copyright zdf",
 "copyright ard",
...
_HALLUCINATION_REPEAT_RE = re.compile(r'^(?:thank you|thanks|bye|you|ok|okay|the end|vielen dank|dankeschön|danke schön|danke|tschüss|\.|\s|,|!)+$',
                                      flags=re.IGNORECASE)
