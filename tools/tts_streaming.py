...
class ElevenLabsStreamer(StreamingTTSProvider):
    ...
    def stream(self, text: str) -> Iterator[bytes]:
        ...
        from tools.tts_tool_providers import (
            DEFAULT_ELEVENLABS_STREAMING_MODEL_ID, DEFAULT_ELEVENLABS_VOICE_ID, _elevenlabs_convert_options,
        ...
        yield from client.text_to_speech.convert(
            ...
            output_format="pcm_24000", **_elevenlabs_convert_options(self.section))
